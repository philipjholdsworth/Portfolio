document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById("VERIDIAN-hosted-system-architecture").addEventListener("click", () => {location.href='https://ams03pap003files.storage.live.com/y4mm2R4KwUSpGkjAZ-2CHnNQxKQx8f1ycdVUxZqoIiw6PcyP1G-m0qBOLJXYsZM6c867msluz-vLuPwvYjHdp3wmOJoRjrzuER8QV2VbdEMHSkSVZom8DpLw4RG94b4mTwulCbJH4QkEbUHczrsBktFBeswgR5Q5NSxOe5FU4u3KjOU1gFGIGbHsY7ACfr4FCtq?width=1604&height=828&cropmode=none'})
  document.getElementById("ansible-website-btn").addEventListener("click", () => {location.href='https://github.com/philipjholdsworth/Auto-Ansible-Lab-Virtual-Box'})
